      ...
      <Container maxW="1200px" px={{ base: 6, md: 10 }} py={5}>
        <Flex justify="space-between" align="center">
          ...
          <HStack spacing={6} display={{ base: 'none', md: 'flex' }}>
            ...
            <Button as={NextLink} href="/signup" variant="ghost" _hover={{ bg: 'whiteAlpha.200' }}>
              Login
            </Button>
            <Button
              as={NextLink}
        ...
        <DrawerContent bg="gray.800">
          ...
          <DrawerBody>
            <VStack as="nav" spacing={6} align="stretch" mt={4}>
              ...
              <Button as={NextLink} href="/signup" variant="outline" colorScheme="purple" onClick={onClose}>
                Login
              </Button>
